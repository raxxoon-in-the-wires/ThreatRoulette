<#
.SYNOPSIS
    Randomized or Manual Threat Actor Emulation using AtomicRed

.DESCRIPTION
    AtomicRedAutomation selects a random Threat Actor from the pool of downloaded Threat Actor TTPs
    ($MitreTTPsLocation) and randomly selects TTPs which are present in both the AtomicRed Atomics
    folder and the MITRE TTPs for that actor.

    Alternatively, allows the user to select the Threat Actor and TTPs manually.
...
Write-Host "`n    #============================================================#"
Write-Host "    |                                                            |"
Write-Host "    |               AtomicRed Emulation Automation               |"
Write-Host "    |                                                            |"
Write-Host "    #============================================================#`n"
Write-Host "`n"
...
Write-Host "`n    #============================================================#"
Write-Host "    |                                                            |"
Write-Host "    |            AtomicRed Emulation Configuration               |"
Write-Host "    |                                                            |"
Write-Host "    #============================================================#"
Write-Host "`n"
...
function ManualConfigThreatActor {
    ...
    Write-Host "    #============================================================#"
    Write-Host "    |                                                            |  "
    Write-Host "    |          AtomicRed Emulation Manual Configuration          |"
    Write-Host "    |                                                            |  "
    Write-Host "    #============================================================#"
    Write-Host "    |                                                            |  "
...
function ManualConfigTTPs {
    ...
    SaveConfig "    #============================================================#"
    SaveConfig "    |                                                            |"
    SaveConfig "    |          AtomicRed Emulation Manual Configuration          |"
    SaveConfig "    |                                                            |"
    SaveConfig "    #============================================================#"
    SaveConfig "    |                                                            |"
...
function AutoConfigTTPs {
    ...
    SaveConfig "    #============================================================#"
    SaveConfig "    |                                                            |"
    SaveConfig "    |          AtomicRed Emulation Automatic Configuration       |"
    SaveConfig "    |                                                            |"
    SaveConfig "    #============================================================#"
    SaveConfig "    |                                                            |"
    SaveConfig "    |             Threat Actor:      $ThreatActor                |"
...
if ($OperationMode -eq "A" -or $OperationMode -eq "Automatic") {
    Write-Host "`n    #============================================================#"
    Write-Host "    |                                                            |"
    Write-Host "    |        AtomicRed Emulation Automatic Configuration         |"
    Write-Host "    |                                                            |"
    Write-Host "    #============================================================#"
